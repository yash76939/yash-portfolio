      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            Crafting stunning and user-friendly digital experiences with modern web technologies. Specialized in building responsive and dynamic front-end applications using React, JavaScript, HTML, and CSS to deliver seamless user interactions.
            </p>
            <div className="flex justify-center lg:justify-start space-x-4 mb-8">
              <a
                href="https://github.com/yash76939"
              ...
              <a
                href="https://www.linkedin.com/in/yash-chouhan-724527260/"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
          ...
          >
            ...
            {/* <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/app/Image/yash.jpg" // Change this to the actual image path
                  alt="Yash Chouhan"
                  width={300}
                  height={300}
                  className="object-cover"
